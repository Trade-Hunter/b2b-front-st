<template>
  <HxcMenu>
    ...
    <div class="flex flex-col no-scrollbar overflow-scroll min-w-full h-full pl-2 pt-1">
      <div class="flex">
        <h2 class="mb-2 text-xl font-extrabold text-gray-900 dark:text-gray-50 font-mono">Realtime Família</h2>
        <div
      ...
      columns: [
        {
          ...
          custom_format: function (obj, value, colIndex, rowIndex) {
            return `<a href="/options/family/${value}" class="font-semibold text-blue-500">${value}</a>`;
          },
        },
        ...
        {
          name: "Qtd. Projetada / Média",
          value: "qprmmqtt",
          format: "float",
        },
        { name: "Volume Total", value: "vtt", total: { calcMode: "sum", format: "int" }, format: "int" },
        { name: "Volume Proj.", value: "vpr", total: { calcMode: "sum", format: "int" }, format: "int" },
        {
          name: "Volume Proj / Média",
          value: "vprmmvtt",
          format: "float",
        },
        {
