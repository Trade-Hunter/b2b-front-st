  ...
  setup() {
    ...
    const components = [
      ...
      },
      {
        ...
        columns: [
          { label: "Ativo", value: "", index: 0, ident: "text-left" },
          { label: "C/V", value: "", index: 2, format: { type: "hora" }, ident: "text-right" },
          { label: "Quant", value: "", index: 3, ident: "text-right" },
          { label: "Preço", value: "", index: 4, format: { type: "int" }, ident: "text-right" },
          { label: "Broker", value: "", index: 5 },
          { label: "Repet", value: "", index: 6 },
      ...
      },
      {
        ...
        columns: [
          ...
          { label: "% Qtt", value: "", index: 5, format: { type: "float" }, ident: "text-right" },
