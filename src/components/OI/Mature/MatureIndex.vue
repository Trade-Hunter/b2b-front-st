<template>
  <HxcMenu>
    ...
    <div class="flex flex-col no-scrollbar overflow-scroll min-w-full h-full pl-2 pt-1">
      <div
        class="flex z-10 bg-white dark:bg-dark-1 py-1 rounded-sm drop-shadow-sm shadow-sm underline text-blue-500 justify-center flex-row mb-1"
      >
        <div
          v-for="chart in availableCharts"
          :key="chart.value"
          @click="currentChart = chart.value"
      ...
      <div class="h-1/2 rounded-sm mb-2 shadow-sm drop-shadow-xl bg-white dark:bg-dark-1 p-1">
      ...
      chart_opts: {
        ...
        series: [
          ...
          },
          {
            ...
            color: "#f23f3f",
            linkedTo: "joe",
            data: chartIndex.series.desc_p,
            stack: "put",
          },
          {
            name: "Travada-put",
            linkedTo: "jane",
            data: chartIndex.series.tr_p,
            stack: "put",
            color: "#f5822a",
          },
        ],
