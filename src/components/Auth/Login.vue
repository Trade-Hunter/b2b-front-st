          ...
          <div class="mt-8">
            <form @submit.prevent>
              ...
              <div class="mt-6">
                <button
                  @click="login"
                  class="w-full px-4 py-2 tracking-wide text-gray-200 transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                >
                  Acessar
                </button>
            ...
            <p class="mt-6 text-sm text-center text-gray-400">
              ...
              <a href="/register" class="text-blue-500 focus:outline-none focus:underline hover:underline"
                >Cadastre-se</a
              >.
            </p>
          </div>
