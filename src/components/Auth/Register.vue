        ...
        <div class="flex-1">
          ...
          <div class="mt-8">
            ...
            <p class="mt-6 text-sm text-center text-gray-400">
              Já tem uma conta?
              <a href="#" class="text-blue-500 focus:outline-none focus:underline hover:underline">Acesse.</a>
            </p>
          </div>
        </div>
      </div>
                ...
                this.$store
                  ...
                  .then(
                    async (result) => {
                      ...
                      if (
                        this.$store.state.user.affiliation &&
                        this.$store.state.user.affiliation.source == "sejabra"
                      ) {
                        window.location =
                          "https://lp.sejabra.com.br/trade-hunter?utm_source=tradehunter&utm_medium=register";
